...
set title "N = 10^9" font 'Calibri,18'
...
plot x title "Linear speedup" with lines lc rgb 'blue' lt 1 lw 2,\
     'res.txt' using 1:2 title "Tasks speedup (threshold = 1000)" with linespoints ls 2,\
     'res2.txt' using 1:2 title "Tasks speedup (threshold = 10000)" with linespoints ls 3