...
plot x title "Linear speedup" with lines lc rgb 'blue' lt 1 lw 2,\
     'n15k.txt' using 1:2 title "N=15000" with linespoints ls 2,\
     'n20k.txt' using 1:2 title "N=20000" with linespoints ls 3,\
     'n25k.txt' using 1:2 title "N=25000" with linespoints ls 4